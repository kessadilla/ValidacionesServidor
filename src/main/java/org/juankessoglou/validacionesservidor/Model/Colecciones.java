...
public class Colecciones {
    ...
    static{
        ...
        listaPaises.put("es", new Pais("{valid-form.paises-pais-espania}", "{valid-form.paises-idioma-castellano}", "34", true, "espania.jpg"));
        listaPaises.put("fr", new Pais("{valid-form.paises-pais-francia}", "{valid-form.paises-idioma-frances}", "33", false, "francia.jpg"));
        listaPaises.put("it", new Pais("{valid-form.paises-pais-italia}", "{valid-form.paises-idioma-italiano}", "39", false, "italia.jpg"));
        listaPaises.put("pt", new Pais("{valid-form.paises-pais-portugal}", "{valid-form.paises-idioma-portugues}", "351", false, "portugal.jpg"));
        listaPaises.put("en", new Pais("{valid-form.paises-pais-uk}", "{valid-form.paises-idioma-ingles}", "44", true, "reino_unido.jpg"));
